...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>
        <asp:DetailsView ID="DetailsView6" runat="server" DataSourceID="SqlDataSource1" Height="50px" Width="884px">
            <Fields>
                <asp:ButtonField Text="Button" />
                <asp:ButtonField ButtonType="Button" CommandName="New" Text="Button" />
            </Fields>
        </asp:DetailsView>
    </p>
    <ol class="round">
